...
//           (sum, stock) => sum + parseFloat(stock.market_value),
//           0
//         );

//         setPreviousValue(portfolioValue); // save before update
...
//     <p className="text-sm text-gray-500 mb-4">Have questions? </p>
//   </div>
//   <a
//     href="/ai-assistant"
//     className="inline-block bg-blue-600 text-white text-sm font-medium py-2 px-4 rounded hover:bg-blue-700 text-center"
//   >
